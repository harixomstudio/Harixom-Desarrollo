...
function RouteComponent() {
  ...
  const photographyPublications = sortedPublications.filter(
    (pub: { category?: string }) =>
      pub.category?.toLowerCase() === "Photography".toLowerCase()
  );

  return <PhotographyPage photographyPublications={photographyPublications} />;
}
