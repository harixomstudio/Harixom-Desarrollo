...
const rankingArtist = ['circles.svg', 'circles.svg', 'circles.svg', 'circles.svg']
const ArtistName = ['Ed Sheeran', 'ebal adadadadadsdadadadsadasdasdasdaa', 'isaac', 'evelyn']
const artName = ['thecircles', 'thecirclessvg', 'circlessvg', 'acirclessvg44sdfsdfsdfsdfsdfsdfsdfsdfsdfsdfdsfsdfsdfsfsdf']
const linksArt = ['', '', '', '', '', '', '', '', '', '']

const commisionsCategories = ['Retratos', 'Diseño de tatuajes', 'Paisajes', 'Diseño de personajes', 'Arte de mascotas', 'Anime/Manga', 'Comisiones personalizadas', 'Fantasía', 'Cartoon', 'Realismo', '', '']
