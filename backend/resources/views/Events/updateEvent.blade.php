        ...
        <div class="w-full h-full bg-[#2c2c2c] rounded-[4rem] p-40 ">
            ...
            <form action="{{route('updateEvent')}}" method="POST">
                ...
                <div class="flex flex-col">
                    <h3 class="mb-4 text-4xl font-semibold ">New Type</h3>
